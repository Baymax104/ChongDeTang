 ...
 * Use the {@link SceneFragment3_1#newInstance} factory method to
...
public class SceneFragment3_1 extends Fragment {
     ...
     * @return A new instance of fragment SceneFragment3_1.
     */
    // TODO: Rename and change types and number of parameters
    public static SceneFragment3_1 newInstance(String param1, String param2) {
        SceneFragment3_1 fragment = new SceneFragment3_1();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.sceneFab31Left.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        binding.sceneFab31Right.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                NavController controller = Navigation.findNavController(v);
        ...
        binding.sceneFab31Down.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
