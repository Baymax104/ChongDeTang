 ...
 * Use the {@link SceneFragment5_1#newInstance} factory method to
...
public class SceneFragment5_1 extends Fragment {
     ...
     * @return A new instance of fragment SceneFragment5_1.
     */
    // TODO: Rename and change types and number of parameters
    public static SceneFragment5_1 newInstance(String param1, String param2) {
        SceneFragment5_1 fragment = new SceneFragment5_1();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.sceneFab51Locate.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        binding.sceneFab51Right.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                NavController controller = Navigation.findNavController(v);
        ...
        binding.sceneFab51Down.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
