...
public class SceneFragment0_3 extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        String url = AppKey.COS_URL + "/img/scenes/img0_3.jpg";
        Glide.with(this)
                .load(url)
                .placeholder(R.drawable.loading)
                .into(binding.sceneImg03);


        binding.sceneFab03Down.setOnClickListener(v -> {
            NavController controller = Navigation.findNavController(v);
            controller.navigate(R.id.action_sceneFragment0_3_to_sceneFragment0_2);
        });
        binding.sceneFab03Locate2.setOnClickListener(v -> {
        ...
        binding.sceneFab03Locate.setOnClickListener(v -> {
