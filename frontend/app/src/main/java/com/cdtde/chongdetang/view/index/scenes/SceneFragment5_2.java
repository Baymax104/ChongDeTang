 ...
 * Use the {@link SceneFragment5_2#newInstance} factory method to
...
public class SceneFragment5_2 extends Fragment {
     ...
     * @return A new instance of fragment SceneFragment5_2.
     */
    // TODO: Rename and change types and number of parameters
    public static SceneFragment5_2 newInstance(String param1, String param2) {
        SceneFragment5_2 fragment = new SceneFragment5_2();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.sceneFab52Down.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        binding.sceneFab52Right.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                NavController controller = Navigation.findNavController(v);
